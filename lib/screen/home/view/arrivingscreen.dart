...
import 'package:ober_driver_app/screen/home/view/waitingforridescreen.dart';

class ArrivingScreen extends StatefulWidget {
  const ArrivingScreen({super.key});
                ...
                child: 
                    ...
                    Column(
                      children: [
                        ...
                        Center(child: semiBoldText("Arriving at", black, 22)),
                        const SizedBox(
                          height: 15,
                        ),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                         ...
                                         width: Get.width < 420 ? Get.width * .60 : Get.width * .75,
                                          child: mediumText("32 London Bridge St, London SE1 9SG", grey, 14))
                                        ],
                                      ),
                        ...
                        SizedBox(
                            ...
                            child: primaryButton(
                                ...
                                color: blue,
                               onpress: (){
                                Get.to(()=>const WaitingforRideScreen());
                               } ),),
                      ],
                    ),
