...
class PickingupScreen2 extends StatefulWidget {
  const PickingupScreen2({super.key});

  @override
  State<PickingupScreen2> createState() => _PickingupScreen2State();
}
