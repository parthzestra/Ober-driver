...
import 'package:ober_driver_app/screen/home/view/collectcashscreen.dart';

class DroppingOffScreen extends StatefulWidget {
  const DroppingOffScreen({super.key});

  @override
  State<DroppingOffScreen> createState() => _DroppingOffScreenState();
}

class _DroppingOffScreenState extends State<DroppingOffScreen> {
      ...
      body: Stack(children: [
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: (){
              Get.to(()=>const ColllectCashScreen());
            },
            child: Container(
                height: 120,
                width: Get.width,
                  ...
                  child: Column(
                    children: [
                     const SizedBox(height: 15,),
                      Center(child: semiBoldText("Dropping off Yarewan", black, 22)),
                      const SizedBox(
                        height: 05,
                      ),
                    ],
